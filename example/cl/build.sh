...
OPENCL_HEADER=/home/shared_dir/ptk-dev/example/cl/opencl/OpenCL-Headers/

##### android armv7
mkdir -p build-android-armv7
pushd build-android-armv7
OPENCL_LIBS=/home/shared_dir/ptk-dev/example/cl/opencl/lib/
...
# OPENCL_LIBS=/home/shared_dir/ptk-dev/example/cl/opencl/lib64/
# cmake -DOPENCL_SDK_INCLUDE:STRING=$OPENCL_HEADER -DOPENCL_SDK_LIB:STRING=$OPENCL_LIBS \
#       -DCMAKE_TOOLCHAIN_FILE=$ANDROID_NDK/build/cmake/android.toolchain.cmake \
