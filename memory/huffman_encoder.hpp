#ifndef PTK_MEMORY_HUFFMAN_ENCODER_HPP_
#define PTK_MEMORY_HUFFMAN_ENCODER_HPP_
	...
	public:
		...
		void BuildTreeFromFreqs(bool is_debug) {
			...
			for (uint32_t i = 1; i < n; ++i) {
				...
				symbol_freqs_[0] = n1->parent = n2->parent 
				                 = CreateNonLeafNode(n1->count + n2->count, n1, n2);
...
#endif // PTK_MEMORY_HUFFMAN_ENCODER_HPP_
